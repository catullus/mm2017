...
reg2016$weekkey_winner <- paste0(reg2016$Wteam,"_",reg2016$Week)
reg2016$weekkey_loser <- paste0(reg2016$Lteam,"_",reg2016$Week)

# this uses the Daynum converted to week
ranks2016 <- steph(select(reg2016, Week, Wteam, Lteam, Outcome), history=TRUE)
x <- c("1.Rating", "11.Rating")
...
reg_weekly_ranks <- merge(reg2016, weekly_ranks, by.x=c("weekkey_winner"), by.y=c("weekkey"))
